...
var (
	schema = []string{
		...
		`CREATE INDEX ` + generic.TableName + `_name_index ON ` + generic.TableName + ` (name)`,
		`CREATE INDEX ` + generic.TableName + `_name_id_index ON ` + generic.TableName + ` (name,id)`,
		`CREATE INDEX ` + generic.TableName + `_id_deleted_index ON ` + generic.TableName + ` (id,deleted)`,
		`CREATE INDEX ` + generic.TableName + `_prev_revision_index ON ` + generic.TableName + ` (prev_revision)`,
		`CREATE UNIQUE INDEX ` + generic.TableName + `_name_prev_revision_uindex ON ` + generic.TableName + ` (name, prev_revision)`,
	}
